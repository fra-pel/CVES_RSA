...
import static com.uvarara.quiz.AppController.StopSound;
import static com.uvarara.quiz.AppController.getAppContext;
...
public class SettingActivity extends AppCompatActivity {
	...
	private void moreAppClicked() {
		try {
			...
			startActivity(new Intent(
					Intent.ACTION_VIEW,
					Uri.parse(String
							.format("http://play.google.com/store/apps/details?id="	+ mContext.getPackageName()))));
		}
	}
	...
	public void viewClickHandler(View view) {
		...
		if (view.getId() == R.id.sound_layout) {
			switchSoundCheckbox();
		}
		if (view.getId() == R.id.sound_checkbox) {
			switchSoundCheckbox();
		}
		if (view.getId() == R.id.vibration_layout) {
			switchVibrationCheckbox();
		}
		if (view.getId() == R.id.vibration_checkbox) {
			switchVibrationCheckbox();
		}
		if (view.getId() == R.id.show_hint_layout) {
			switchMusicEnableCheckbox();
		}
		if (view.getId() == R.id.show_music_checkbox) {
		...
		if (view.getId() == R.id.moreapp_layout) {
			moreAppClicked();
			overridePendingTransition(R.anim.open_next, R.anim.close_next);
		}

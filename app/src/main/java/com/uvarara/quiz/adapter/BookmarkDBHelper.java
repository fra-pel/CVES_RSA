...
public class BookmarkDBHelper extends SQLiteOpenHelper {
    ...
    public void db_delete() {
        ...
        if (file.exists()) {
            file.delete();
            System.out.println("Cancella file database.");
        }
    }
    ...
    public void insertIntoDB(int que_id, String question, String answer, String solution) {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "INSERT INTO " + TABLE_NAME + "(" + QUE_ID + "," + QUESTION + "," + ANSWER + "," + SOLUTION + ")VALUES('" + que_id + "', '" + question + "', '" + answer + "', '" + solution + "');";
        db.execSQL(query);
    ...
    public ArrayList<Bookmark> getAllBookmarkedList() {
        ...
        while (c.moveToNext()){
            ...
            System.out.println("sol:--" + c.getString(c.getColumnIndex(QUESTION)));

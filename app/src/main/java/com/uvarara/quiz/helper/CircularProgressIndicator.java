package com.uvarara.quiz.helper;
...
public class CircularProgressIndicator extends View {
    ...
    private static final String DEFAULT_PROGRESS_COLOR = "#ffffff";
    private static final int DEFAULT_TEXT_SIZE_SP = 10;
    private static final int DEFAULT_STROKE_WIDTH_DP = 10;
    private static final String DEFAULT_PROGRESS_BACKGROUND_COLOR = "#61beed";
    ...
    public void SetTimerAttributes(int progressColor, int dotColor, int progressBackgroundColor, int textColor, int textSize) {
        ...
        setProgressStrokeWidthDp(DEFAULT_TEXT_SIZE_SP);
        setDotWidthDp(DEFAULT_TEXT_SIZE_SP);
    }

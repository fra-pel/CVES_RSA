...
import com.uvarara.quiz.AppController;
import com.uvarara.quiz.Constant;
import com.uvarara.quiz.activity.MainActivity;
import com.uvarara.quiz.R;
import com.uvarara.quiz.activity.SettingActivity;
import com.uvarara.quiz.helper.CheckNetworkConnection;
import com.uvarara.quiz.helper.CircularProgressIndicator;
import com.uvarara.quiz.helper.CircularProgressIndicator2;

import com.uvarara.quiz.helper.SettingsPreferences;
import com.uvarara.quiz.model.QuizLevel;
import com.uvarara.quiz.model.Review;
...
import static com.uvarara.quiz.activity.MainActivity.context;
import static com.uvarara.quiz.activity.MainActivity.mRewardedAd;
...
/*
    public static final int A_LAYOUT = R.id.a_layout;
    private static final int B_LAYOUT = R.id.b_layout;
    private static final int C_LAYOUT = R.id.c_layout;
    private static final int D_LAYOUT = R.id.d_layout;
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView imgScore = v.findViewById(R.id.imgScore);
...
/*
        v.findViewById(A_LAYOUT).setOnClickListener(this);
        v.findViewById(B_LAYOUT).setOnClickListener(this);
        v.findViewById(C_LAYOUT).setOnClickListener(this);
        v.findViewById(D_LAYOUT).setOnClickListener(this);
...
*/
        ...
        // Carica un annuncio Rewarded
        loadRewardedAd(getContext());

        // Carica un annuncio Interstitial
        //loadInterstitialAd(getActivity());



        //RewardedAd.setRewardedVideoAdListener(rewardedVideoAdListener);
        ...
        try {
            ...
            // Crea una nuova richiesta di annuncio
            //AdRequest adRequest = new AdRequest.Builder().build();
            ...
            InterstitialAd.load(getContext(), getString(R.string.admob_interstitial_id), adRequest, new InterstitialAdLoadCallback() {
                ...
                public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                    ...
                    interstitial.setFullScreenContentCallback(new FullScreenContentCallback() {
                        ...
                        public void onAdShowedFullScreenContent() {
                            // Ferma il timer quando l'annuncio viene mostrato
                        ...
                        public void onAdDismissedFullScreenContent() {
                            // Avvia il timer dopo che l'annuncio è stato chiuso
                ...
                public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                    // Fallimento del caricamento dell'annuncio
                    interstitial = null;
                }
            });
        } catch (Exception e) {
    ...
    public void ShowRewarded(final Context context) {
        ...
        if (!CheckNetworkConnection.isConnectionAvailable(getActivity())) {
            ...
            dialog.setTitle("Errore di connessione Internet!");
            dialog.setMessage("Errore di connessione Internet! Prego collegarsi a Internet!");
    ...
    private void showRewardedAd() {
        if (mRewardedAd != null) {
            ...
            // Ricarica l'annuncio se non è disponibile
            loadRewardedAd(getContext());
        }
    }
    ...
    public static void loadRewardedAd(Context context) {
        ...
        RewardedAd.load(context, context.getString(R.string.admob_Rewarded_Video_Ads), adRequest, new RewardedAdLoadCallback() {
            @Override
    ...
    public void loadInterstitialAd(Activity activity) {
        AdRequest adRequest = new AdRequest.Builder().build();
        InterstitialAd.load(activity, activity.getString(R.string.admob_interstitial_id), adRequest, new InterstitialAdLoadCallback() {
            @Override
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                interstitial= interstitialAd;
                interstitial.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                // Mostra l'annuncio appena caricato
                displayInterstitial(activity);
            }
    ...
    public void levelCompleted() {
        ...
        Constant.CorrectQuestion = correctQuestion;
        Constant.WrongQuestion = inCorrectQuestion;
        myCountDownTimer.cancel();
        editor = settings.edit();
        if (correctQuestion >= Constant.media_punteggio && levelNo == Constant.RequestlevelNo) {
            levelNo = levelNo + 1;
...
//            }
        ...
        if (correctQuestion >= Constant.media_punteggio) {
        ...
        } else if (correctQuestion >= 2 && correctQuestion <= 4) {
            coin = coin + 1;
            level_coin = 1;
            Constant.level_coin = level_coin;
        } else if (correctQuestion >= 5 && correctQuestion <= 7) {
            coin = coin + 2;
            level_coin = 2;
            Constant.level_coin = level_coin;
    ...
    private void resetAllValue() {
        ...
        tvLevel.setText("Livello" + " : " + Constant.RequestlevelNo);

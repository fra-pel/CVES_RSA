...
import com.uvarara.quiz.helper.CircleImageView;
...
public class FragmentSubcategory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txtblanklist.setText("Categoria non disponibile");
    ...
    public void setSnackBar(View coordinatorLayout) {
        Snackbar snackbar = Snackbar
                .make(coordinatorLayout, "Nessuna connessione INTERNET!", Snackbar.LENGTH_INDEFINITE)

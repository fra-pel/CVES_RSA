...
import com.uvarara.quiz.model.Level;
...
public class FragmentLock extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tvLevel.setText("Seleziona Livello");
...
//        Constant.subCategoryId
        ...
        for (int i = 0; i < Constant.totalLevel; i++) {
            Level card = new Level("" + i, "Livello" + " : " + (i + 1), levelNo);
            levelList.add(card);
        }
            ...
            viewHolder.cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (levelNo >= position + 1) {
                        ...
                        Toast.makeText(activity, "Questo livello è bloccato", Toast.LENGTH_SHORT).show();
                    }

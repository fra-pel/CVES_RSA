...
import com.uvarara.quiz.activity.ReviewActivity;
...
//        levelNo = MainActivity.DBHelper.GetLevelByIdUsingSingleCat(Constant.categoryId);
        ...
        txtLevel.setText("Livello" + ": " + Constant.RequestlevelNo);
        ...
        result_prog.setCurrentProgress((double) getPercentageCorrect(Constant.TotalQuestion, Constant.CorrectQuestion));
        // result_prog.setUnit("%");
        txt_right.setText("" + Constant.CorrectQuestion);
        txt_wrong.setText("" + Constant.WrongQuestion);
        return v;
    }
    ...
    public void onClick(View v) {
        //switch (v.getId()) {
            if (v.getId() == R.id.btn_playagain) {
                fragmentPlay.displayInterstitial(getActivity());
        ...
        if (v.getId() == R.id.btn_share) {
            fragmentPlay.displayInterstitial(getActivity());
            final String sharetext = "Ho finito il livello n. : " + levelNo + " con un punteggio di: " + lastLevelScore;
